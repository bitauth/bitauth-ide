  ...
  return (
    ...
    >
      <div className={Classes.DIALOG_BODY}>
        ...
        <p>
          For <code>signature</code> and <code>schnorr_signature</code>, the
          following signing serialization algorithms are available:
        </p>
        <ul>
          <li>
            <code>all_outputs</code>– A.K.A. "SIGHASH_ALL"
          </li>
          <li>
            <code>all_outputs_single_input</code>– A.K.A. "SIGHASH_ALL" and
            "ANYONE_CAN_PAY"
          </li>
          <li>
          ...
          <li>
            ...
            "SIGHASH_SINGLE" and "ANYONE_CAN_PAY"
          </li>
          <li>
            <code>no_outputs</code>– A.K.A. "SIGHASH_NONE"
          </li>
          <li>
            <code>no_outputs_single_input</code>– A.K.A. "SIGHASH_NONE" and
            "ANYONE_CAN_PAY"
          </li>
        </ul>
        <h3>Evaluations</h3>
